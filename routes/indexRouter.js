...
const { homepage, studentsignup, studentsignin, studentsignout, StudentUpdate, CurrentStudent, ResetPassword, studentForgetPassword, ChangePassword, StudentAvatar } = require('../controllers/indexController');
